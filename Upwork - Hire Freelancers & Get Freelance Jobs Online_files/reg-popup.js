...
//# sourceMappingURL=angular.min.js.map
    ...
    (function(){
        var widget = document.getElementsByTagName('mc-reg-popup');

        if (!widget.length) { // legacy version
            widget = document.getElementsByClassName('upwork-reg-popup');
        }


        if (document.querySelectorAll('[ng-app]').length || document.querySelectorAll('[data-ng-app]').length ) {
            angular.element(document).ready(function () {
                angular.injector(['ng', 'marketing-widget.reg-popup'])
            ...
            angular.element(document).ready(function () {
                angular.bootstrap(widget, ['marketing-widget.reg-popup']);
            });
        }
    })();
...
angular.module("marketing-widget.reg-popup.templates", []).run(["$templateCache", function($templateCache) {$templateCache.put("reg-popup-modal.html","<div modal-render=\"{{$isRendered}}\" tabindex=\"-1\" role=\"dialog\" uib-modal-animation-class=\"fade\" modal-in-class=\"in\" ng-style=\"{\'z-index\': 1050 + index*10, display: \'block\'}\" class=\"upo6iqBiXa\">\n  <div class=\"up76cAzcME upALiyBiog up76TE8TMy up5dco7cKd upbai9eira upjnTMETB5 upALcyqcog upXjigKidb\" style=\"width: 952px;\">\n    <div ng-transclude=\"\" class=\"upEyT6AT5q\"></div>\n  </div>\n</div>");
$templateCache.put("reg-popup.html","<div class=\"upRjiR5KTp\">\n    <a ng-click=\"close()\" olog-trigger=\"\" olog-name=\"vs_reg_popup_close\" olog-event=\"click\" olog-location=\"{{ track_location }}\" gtm-trigger=\"click\" gtm-event=\"vs-reg-popup-close\" gtm-data=\"{\n       &quot;category&quot; : &quot;{{ track_location }}&quot;\n     }\" class=\"up5dcoqcKd\">\n      <svg xmlns=\"http://www.w3.org/2000/svg\" viewbox=\"-298 390 14 14\" class=\"upo6i7xiXa\">\n        <path d=\"M-284 391.3l-1.3-1.3-5.7 5.7-5.7-5.7-1.3 1.3 5.7 5.7-5.7 5.7 1.3 1.3 5.7-5.7 5.7 5.7 1.3-1.3-5.7-5.7\"></path>\n      </svg>\n    </a>\n\n    <div class=\"up8KTj8TEe upKXcL6cxe\">\n      <h2 class=\"upMaixpizr upe9TdzT8x\">Join Upwork. Get top-notch work easily.</h2>\n      <iframe scrolling=\"no\" src=\"https://www.upwork.com/signup/create-account/client_direct_marketing_iframe\" class=\"upgXcKqcrp\">\n      </iframe>\n    </div>\n    <div class=\"uppKin8iEe upKXcL6cxe upe9TdzT8x\">\n      <div class=\"upo6T5oTXa\">\n        <img height=\"65\" width=\"45\" ng-src=\"{{ getImage(\'freelancer.svg\') }}\" class=\"upR7c8ocGa\" />\n        <span><strong class=\"upqMiXrikg\">Quality freelancers</strong>in 3,000+ skill categories</span>\n      </div>\n      <div class=\"upo6T5oTXa\">\n        <img height=\"55\" width=\"45\" ng-src=\"{{ getImage(\'timer.svg\') }}\" class=\"upR7c8ocGa\" />\n        <span><strong class=\"upqMiXrikg\">Hire in an hour</strong>and kick off projects ASAP</span>\n      </div>\n      <div class=\"upo6T5oTXa\">\n        <img height=\"65\" width=\"45\" ng-src=\"{{ getImage(\'lock.svg\') }}\" class=\"upR7c8ocGa\" />\n        <span><strong class=\"upqMiXrikg\">Payment protection</strong>for peace of mind</span>\n      </div>\n      <div class=\"upR7T8LTGa\">\n        Want to be a freelancer?\n        <a href=\"https://www.upwork.com/signup/create-account/freelancer_direct/\" olog-trigger=\"\" olog-name=\"vs_reg_popup_fl_reg\" olog-event=\"click\" olog-location=\"{{ track_location }}\" gtm-trigger=\"click\" gtm-event=\"vs-reg-popup-fl-reg\" gtm-data=\"{\n              &quot;category&quot; : &quot;{{ track_location }}&quot;\n           }\">Sign up</a>\n      </div>\n    </div>\n</div>");}]);
(function() {
    angular.module('marketing-widget.reg-popup', [
        'ngCookies',
        'ui.bootstrap.modal',
        'marketing-widget.reg-popup.templates',
        'cssManager',
...
(function() {
    ...
    function config() {
        ...
        function getCss() {
            switch (environment) {
                case 'dev'  :
                    return '//localhost:4020/dist/reg-popup/reg-popup.css';
                default     :
                    return '//components.elance-odesk.com/marketing-widget/1.1.9/dist/reg-popup/reg-popup.css';
            }
        }
        ...
        function getImagePath() {
            switch (environment) {
                case 'dev'  :
                    return '//localhost:4020/dist/reg-popup/img/';
                default     :
                    return '//components.elance-odesk.com/marketing-widget/1.1.9/dist/reg-popup/img/';
            }
        }
        ...
        function getTheme(theme) {
            ...
            switch (environment) {
                case 'dev'  :
                    return '//localhost:4020/dist/reg-popup/themes/' + theme + '.css';
                default     :
                    return 'https://components.elance-odesk.com/marketing-widget/1.1.9/dist/reg-popup/themes/' + theme + '.css';
            }
        }
...
(function () {
    angular.module('marketing-widget.reg-popup')
        .directive('mcRegPopup', mcRegPopup);

    var MIN_CLIENT_WIDTH = 992;

    mcRegPopup.$inject = ['$window', '$modal', 'cssManager', 'config'];
    function mcRegPopup($window, $modal, cssManager, config) {
        return {
            restrict: 'E',
            scope: {
                env: '@',
        ...
        function link(scope) {
            ...
            if (localStorage.getItem('reg-popup-viewed') || $window.innerWidth < MIN_CLIENT_WIDTH || !scope.pivot) {
                return;
            }
            ...
            var views = JSON.parse(localStorage.getItem('reg-popup-views')) || [];
            views.push(Date.now());
            localStorage.setItem('reg-popup-views', JSON.stringify(views));

            var showNow = false;
            if (!scope.trigger || !times || (scope.trigger === 'recency' && !days)) {
                showNow = true;
            }
            if (scope.trigger === 'recency') {
                var count = views.filter(function(el) {
                    return parseInt(el) > Date.now() - 86400 * 1000 * days;
                }).length;
                if (count >= times) {
                    showNow = true;
                }
            } else if (scope.trigger === 'frequency') {
                if (views.length >= times) {
                    showNow = true;
                }
            }
            ...
            var modalInstance = null,
                pivot = document.querySelector(scope.pivot);
            ...
            if (pivot) {
                angular.element($window).bind("scroll", checkPivot);
                checkPivot();
            } else {
                openPopup();
            }
            ...
            function close() {
                ...
                localStorage.setItem('reg-popup-viewed', true);
            }

            function getImage(filename) {
                return config.getImagePath() + filename;
            }

            function openPopup() {
                modalInstance = $modal.open({
                    templateUrl: 'reg-popup.html',
                    scope: scope,
                    windowTemplateUrl: 'reg-popup-modal.html'
                });
            }

            function checkPivot() {
                if ($window.pageYOffset >= pivot.getBoundingClientRect().top) {
                    angular.element($window).unbind('scroll', checkPivot);
                    openPopup();
                }
            }
        }
